...
void rands(int n, double *x, double a = 1.0, double b = 0.0); // x = [(0~1)*a+b, ...]
...
// bool bicg(int n, double *A, double *x, double *b, int maxattempts = 100, int maxiters = 1000, double tol = 1e-6);
